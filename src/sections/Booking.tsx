...
export default function Booking() {
  ...
  return (
    <section id="booking" className="relative py-28 px-6 lg:px-12 border-t border-white/10" style={{ background: 'radial-gradient(ellipse at 25% 50%, #000f22 0%, #00060f 50%, #010203 100%)' }}>
